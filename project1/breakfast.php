...
<div class="container">    
	...
	<?php
		...
		<div class="col-lg-3 col-md-4 col sm-6 ">	   
			<div class="card-deck">
				<div class="card p-1">
					<img src="<?php echo $row['image'];?>" class="card-img-top" height="250px">
			...
			<form class="form-submit" method="POST" action="action.php?action=add&id=<?php echo $row['id'];?>">
				...
				<input type="hidden" name="pcode" value="<?php echo $row['pccode'];?>">
				
				<input type="submit" class="btn btn-info btn-block" name="add_to_cart" value="Add to Cart">
			</form>
			</div>
			</div>
		</div>
